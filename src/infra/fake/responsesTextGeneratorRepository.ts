import { ResponsesTextGenerator } from '@/data/protocols/responsesTextGenerator'

export class ResponsesTextGeneratorRepository
  implements ResponsesTextGenerator
{
